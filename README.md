...
My personal TryHackMe room tracker.

> **Source / Credit**
> The initial room list is based on [`winterrdog/tryhackme-free-rooms`](https://github.com/winterrdog/tryhackme-free-rooms).
> Credit to **winterrdog** for compiling and categorising the original list.
...
<!-- - [Basics of Linux](https://linuxjourney.com/) -- added this since the fundamentals rooms were all made premium. In case you need deeper study into Linux read follow these: -->
...
## Cyber Security 101
- [TryHackMe | Defensive Security Intro](https://tryhackme.com/room/defensivesecurityintroQR)
...
<!-- - [TryHackme | Web Attack Forensics - Drone Alone](https://github.com/winterrdog/tryhackme-free-rooms/blob/main) -->
